package com.shrimp.extensions.particle.threeD.actions {
	...
	import com.shrimp.extensions.particle.threeD.actions.waypoints.Waypoint3D;
	...
	public class FollowWaypoints3D extends Action3D {
		...
		override public function parseXML(xml:XML, builder:XMLBuilder = null):void {
			...
			clearWaypoints();
			for each (var node:XML in com.shrimp.extensions.particle.threeD.actions.waypoints.Waypoint3D) {
